...
\newif\ifdraft\draftfalse  % change to '\draftfalse'
...
\begin{document}
	...
	% Remove before submission: Start the bibliography on a new page, to make
	% it more obvious how close we are to the page limit.
